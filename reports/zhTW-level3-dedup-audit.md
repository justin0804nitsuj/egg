...
This report presents a thorough linguistic audit of all **916** merged duplicate sense groups in Level 3 vocabulary.
...
| :--- | :---: | :---: |
| **Total Merged Groups Audited** | **916** | 100% |
| **SAFE_DUPLICATE** (Valid mergers) | **916** | 100.0% |
| **POSSIBLE_OVER_MERGE** (Nuanced / distinct usage) | **0** | 0.0% |
| **CLEAR_OVER_MERGE** (Must be separated) | **0** | 0.0% |
| **Total Affected Words** | **756** | - |
