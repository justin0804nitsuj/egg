...
This report presents a thorough linguistic audit of all **1014** merged duplicate sense groups in Level 1 vocabulary.
...
| :--- | :---: | :---: |
| **Total Merged Groups Audited** | **1014** | 100% |
| **SAFE_DUPLICATE** (Valid mergers) | **1014** | 100.0% |
| **POSSIBLE_OVER_MERGE** (Nuanced / distinct usage) | **0** | 0.0% |
| **CLEAR_OVER_MERGE** (Must be separated) | **0** | 0.0% |
| **Total Affected Words** | **775** | - |
